    ...
    asc
      ...
      .then((result) => {
        ...
        document.getElementById("wasm4-cart-json").innerHTML = JSON.stringify({
          ...
          WASM4_CART_SIZE: result.binary.length,
        });
...
<main class="h-screen p-2 text-gray-700 bg-gray-50 overflow-x-none">
  <script id="wasm4-cart-json" type="application/json"></script>
  <script id="wasm4-disk-prefix" type="text/plain">
Wasm4 Demo Game
  </script>
  <!--
        <div class="md:w-2/3 lg:w-1/2 mx-auto space-y-2 flex">
